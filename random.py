...
if usrinput == "5":
    ...
    print(output2)
#Kill
if usrinput == "5": #developer's note: i need to figure out how to replace values because not all kill messages have the name at the beginning
    usrinput = input("Who do you want to kill? ")
